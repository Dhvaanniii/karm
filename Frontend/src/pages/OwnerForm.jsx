          ...
          <div className='bg-white rounded-2xl shadow-xl w-full max-w-md'>
            <div className='p-6'>
              <div className='flex justify-between items-center mb-4'>
                ...
                <button
                  onClick={() => {
                    setCredentialsModal({ show: false, username: '', password: '' })
                    navigate("/residentmanagement")
                    setFormData({
                      Member_Counting: [],
                      Vehicle_Counting: [],
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4'>
                <p className='text-sm text-blue-800 font-medium mb-2'>
                  ⚠️ Important: Save these credentials and share them with the resident
                </p>
                <div className='space-y-3'>
                  <div>
                    <label className='text-xs text-gray-600 font-medium'>Username (Email):</label>
              ...
              <div className='text-center mb-4'>
                <p className='text-gray-600 text-sm'>
                  These credentials have also been sent via email to the resident.
                </p>
              </div>
